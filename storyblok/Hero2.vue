<template>
  <div v-editable="blok" class="relative w-full h-screen overflow-hidden">
    ...
    <div v-else-if="blok.background_image && blok.background_image.filename" class="absolute inset-0 h-full w-full bg-cover bg-center"
...
@media (max-width: 480px) {
  .text-headline4 { font-size: 1.25rem; }
  .text-headline3 { font-size: 1.875rem; }
  .text-headline2 { font-size: 2.5rem; }
  .text-display { font-size: 5rem; }
  .text-paragraph2 { font-size: 0.875rem; }
  .paragraphIcon { font-size: 0.75rem; }
}
